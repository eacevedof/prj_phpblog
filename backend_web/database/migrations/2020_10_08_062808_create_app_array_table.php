...
class CreateAppArrayTable extends Migration {
	...
	public function up()
	{
		Schema::create('app_array', function(Blueprint $table)
		{
			...
			$table->string(''url_final'', 200)->nullable();
			$table->integer('id_user')->nullable()->comment('propietario del tipo o categoria');
