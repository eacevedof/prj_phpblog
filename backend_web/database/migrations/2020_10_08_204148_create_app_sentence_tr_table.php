...
class CreateAppSentenceTrTable extends Migration {
	...
	public function up()
	{
		Schema::create('app_sentence_tr', function(Blueprint $table)
		{
			...
			$table->string("translated", 2000)->nullable()->comment('texto traducido');
			$table->integer('id_language')->nullable()->comment('app_language.id');
			$table->integer('id_sentence')->nullable()->comment('app_sentence.id');
