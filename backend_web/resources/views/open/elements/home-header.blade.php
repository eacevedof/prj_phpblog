<div class="card app-card">
    ...
    <div class="card-body">
        <img src="https://resources.theframework.es/eduardoaf.com/20200906/095050-logo-eduardoafcom_500.png" width="450" class="pull-left mr-3 img-fluid">
        <p class="card-text">
            ...
            <br/><br/>
            Originalmente empecé con <b>Visual Basic 6</b>, <b>Microsoft Access</b> y <b>VBA</b>. Posteriormente apareció <b>C#</b> y me dediqué
            a aprenderlo apoyandome en el libro <i>"Visual C# .Net de Anaya"</i> pudiendo realizar dos proyectos uno personal y otro en una agencia de viajes.
            Entonces casi todas mis busquedas de dudas sobre VB y C# acababan en la web de <i>"el guille (elguille.info)"</i> con excelente contenido en lo que a <b>.NET</b>
            se refiere.
            <br/><br/>
            ...
            <ul>
                <li>PHP 7 y 8, Yii 2, Symfony 5 y Laravel 7, REST</li>
                <li>Python, Django, Flask y Selenium</li>
                <li>SQL Server, Mysql, MongoDB, Hive y Redis</li>
                <li>Vanilla Js, jQuery, Rxjs, VueJs, Svelte y ReactJs</li>
                <li>CSS, Vuetify, Bootstrap y Bulma</li>
                <li>Docker y Vagrant</li>
                <li>Flutter y Android</li>
                <li>Figma</li>
                <li>.Net Core</li>
                <li>Windows, Mac OS, Linux</li>
            </ul>
            La idea de este blog es plasmar todas aquellas experiencias y soluciones relevantes que voy experimentando
            en el uso de dichas herramientas.
        </p>
        <p class="text-right">
            <a href="/contacto" class="btn app-btnblue app-btnshadow">Contacta conmigo</a>
        </p>
    </div>
