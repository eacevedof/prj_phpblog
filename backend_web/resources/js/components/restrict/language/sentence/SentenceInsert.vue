        ...
        <form id="form-insert" @submit="handleSubmit">
            ...
            <div class="form-row mt-1">
                <div class="form-group col-md-4">
                    ...
                    <select id="sel-id_context" v-model="sentence.id_context" class="form-control" required>
                ...
                <div class="form-group col-md-12">
                    ...
                    <textarea id="txa-translatable" v-model="sentence.translatable" maxlength="1000" rows="3" cols="5" class="form-control"></textarea>
                </div>
...
<script type="module" src="./sentenceinsert.js"></script>
